...
class Game {
  constructor(ui) {
    ...
    // Bind handlers to UI so we can detectinput change from the Game class
  ...
  /**
   * Supprt WASD and arrow key controls. Update the direction of the snake.
   */
   ...
   * increasing by one velocity. Removeone item from the end of the array to
   * make the snake move, unless thesnake collides with a dot - then increase
